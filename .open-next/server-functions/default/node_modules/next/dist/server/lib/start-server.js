...
/* build-hook-start *//*00001*/try { require('c:\\Users\\alpuk\\.vscode\\extensions\\wallabyjs.console-ninja-1.0.486\\out\\buildHook\\index.js').default({tool: 'next.js', checkSum: '20f3211917b1c1bd1e0073VwYcBB8LCw8EAlMEVF0CVAcAVVJS', mode: 'build.native', condition: process.env.TURBOPACK === "1"}); } catch(cjsError) { try { import('file:///c:/Users/alpuk/.vscode/extensions/wallabyjs.console-ninja-1.0.486/out/buildHook/index.js').then(m => m.default.default({tool: 'next.js', checkSum: '20f3211917b1c1bd1e0073VwYcBB8LCw8EAlMEVF0CVAcAVVJS', mode: 'build.native', condition: process.env.TURBOPACK === "1"})).catch(esmError => {}) } catch(esmError) {}}/* build-hook-end */
