...
/* build-hook-start *//*00001*/try { require('c:\\Users\\alpuk\\.vscode\\extensions\\wallabyjs.console-ninja-1.0.490\\out\\buildHook\\index.js').default({tool: 'next.js', checkSum: '20bd71500dfe9b83991e23U1EZBBsCClRSVAtVXQAMCVBTBQBR', mode: 'build.native', condition: process.env.TURBOPACK === "1" || process.env.TURBOPACK === "auto"}); } catch(cjsError) { try { import('file:///c:/Users/alpuk/.vscode/extensions/wallabyjs.console-ninja-1.0.490/out/buildHook/index.js').then(m => m.default.default({tool: 'next.js', checkSum: '20bd71500dfe9b83991e23U1EZBBsCClRSVAtVXQAMCVBTBQBR', mode: 'build.native', condition: process.env.TURBOPACK === "1" || process.env.TURBOPACK === "auto"})).catch(esmError => {}) } catch(esmError) {}}/* build-hook-end */
...
async function startServer(serverOptions) {
    ...
    process.title = `next-server (v${"15.5.2"})`;
    let handlersReady = ()=>{};
    let handlersError = ()=>{};
